...
export class MuseosService {
  ...
  museos: Museo[] = [
    {id:1,nombre:'Museo del Prado',telefono:'913 30 28 00',direccion:'Calle de Ruiz de Alarcón, 23, 28014 Madrid',horario:'10:00 – 20:00',imagen:'https://content2.cdnprado.net/imagenes/proyectos/personalizacion/7317a29a-d846-4c54-9034-6a114c3658fe/cms/puerta-velazquez.png',web:'https://www.museodelprado.es/',coordenadas:[40.4137818,-3.6921271],precio:15,abierto:true},
    {id:2,nombre:'Reina Sofia',telefono:'917741000',direccion:'Calle Santa Isabel',horario:'Cierra a las 21:00',imagen:'https://estaticos.esmadrid.com/cdn/farfuture/cYOU8k53hninHmHxypO2OIUoSFyKVDLKGNzwGNmsvy4/mtime:1646729170/sites/default/files/styles/content_type_full/public/recursosturisticos/infoturistica/F_E_EA_1210_GD_reina_sofia_40_alta.jpg?itok=uJ0FjMIo',web:'https://www.museoreinasofia.es',coordenadas:[40.408644,-3.693992],precio:15,abierto:true },
    {id:3,nombre:'Biblioteca Nacional',telefono:' 91 516 89 67 / 91 580 77 59',direccion:'Paseo de Recoletos, 20-22. 28071. Madrid.',horario:'De Martes a Sabado de 10 a 20 h. Domingos de 10 a 14 h.',imagen:'https://upload.wikimedia.org/wikipedia/commons/thumb/2/27/Biblioteca_Nacional_de_Espa%C3%B1a_%28Madrid%29_09.jpg/490px-Biblioteca_Nacional_de_Espa%C3%B1a_%28Madrid%29_09.jpg',web:'https://www.bne.es/es',coordenadas:[40.42348498519113, -3.6910447306827954],precio:0,abierto:true},

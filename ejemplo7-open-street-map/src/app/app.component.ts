...
export class AppComponent {
  ...
  options: Leaflet.MapOptions = {
    layers: getLayers(),
    zoom: 12,
    center: new Leaflet.LatLng(41.6369216, -0.8996619)
  };
}

export const getMarkers = (): Leaflet.Marker[] => {
  return [
    new Leaflet.Marker(new Leaflet.LatLng(41.6369216, -0.8996619), {
    ...
    new Leaflet.Marker(new Leaflet.LatLng(41.6369216, -0.9996619), {
      icon: new Leaflet.Icon({
        iconSize: [50, 41],
        iconAnchor: [13, 41],
